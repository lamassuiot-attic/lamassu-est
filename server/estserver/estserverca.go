...
func NewServerCa(ca est.CA) (*http.Server, error) {
	...
	secretsVault, err := vault.NewVaultSecrets(configVault.VaultAddress, configVault.VaultRoleID, configVault.VaultSecretID, configVault.VaultCA, configVault.OcspUrl, logger)
	if err != nil {
		return nil, err
	}
